        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button className="text-sm font-medium transition-colors hover:text-[#1A7C4B] text-[#1A7C4B]">
                Home
              </button>
              <button className="text-sm font-medium transition-colors hover:text-[#1A7C4B] text-muted-foreground">
                About
              </button>
              <button className="text-sm font-medium transition-colors hover:text-[#1A7C4B] text-muted-foreground">
                Education
